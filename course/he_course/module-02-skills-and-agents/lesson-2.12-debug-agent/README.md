...
- You can show the original error, the fix, and the rerun result.
- The change is narrow and clearly tied to the root cause.

## Next

- [Lesson 2.13 — Agent context and sharp prompts](../lesson-2.13-agent-context-prompts/README.md)

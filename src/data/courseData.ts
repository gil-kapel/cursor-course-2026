...
אחרי שסיימתם, יש לכם בסיס להמשיך לשרשרת הסוכנים: PRD, ארכיטכטורה, UX — כל אחד עם הסקיל שלו.`,
        ...
        },
        {
          ...
          prompts: [
            'אתה Security Agent. מטרה: לעצור טעויות אבטחה מוקדם. קלט: @prd-v0.md + @architecture-handoff.md + @ui-handoff.md. פלט: הסיכונים המרכזיים, חומרה משוערת, ו-3 צעדים מעשיים לפני מימוש רחב. התמקד ב-auth, permissions, secrets, data exposure, abuse.',
            'אתה Security Agent. אל תכתוב threat model ארוך. פלט: Risk, למה הוא חשוב, ומה הצעד הבא בפרויקט הזה.',
            'אתה Security Agent. בדוק את V1 בלבד. קלט: @prd-v0.md @architecture-handoff.md. פלט: הרשאות, סודות, דליפת מידע, abuse cases, ומה חייבים לסגור לפני build רחב.',
          ],
          checklist: [

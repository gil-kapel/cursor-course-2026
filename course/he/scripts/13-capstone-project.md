...
- Visual: preview deployment קצר (או סימולציה של S3/CloudFront לפי מה שלימדנו בשיעור הפריסה).
- Narration:
  "כשהפיצ'ר עובד מקומית, לא עוצרים. מעלים גרסה לבדיקה מחוץ למחשב — למשל בנתיב שלמדתם במסלול הבסיסי עם Vercel, או בנתיב המתקדם עם S3 ו-CloudFront — בודקים שהכול רץ, ומוודאים שה-config וה-env תואמים. זו הסגירה האמיתית של הלופ."

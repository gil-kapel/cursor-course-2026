# Full Stack Developer Known Gaps & Limitations
...
- .NET Core/ASP.NET applications
- jQuery-based frontends
...
**Reason:** These require domain-specific knowledge beyond general fullstack development.
...
- NewSQL databases (PlanetScale, Xata)
...
- Message queue architectures (RabbitMQ, Apache Kafka)
...
- Emacs development workflows
- VS Code alternatives (Cursor, Windsurf, Zed)
...
- Azure ARM templates
- Pulumi cross-language IaC
- CDK constructs development
...
- AWS SES vs Postmark vs Mailgun comparison
- Auth0 vs Firebase Auth vs custom JWT
- Stripe vs Braintree vs Adyen payment flows
- Segment vs Mixpanel vs Amplitude analytics
...
- **Monitoring stacks** for production observability
- **CI/CD pipelines** for automated deployment
- **Documentation generation** for API and code

**When to use specialized skills:** Complex requirements beyond the builder's scope require domain-specific expertise.

**When to extend the builder:** Custom integrations and advanced features should be added as builder extensions rather than manual development.

---

**This skill provides comprehensive fullstack development guidance for 95% of web application scenarios. For specialized requirements beyond this scope, consult the complementary skills listed above.**
